...
public class SportsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("member_manager create_match \"sport_name\" \"match_name\" \"team1_name\" \"team2_name\": create a match");
        System.out.println("member_manager bet \"sport_name\" \"member_name\" \"match_name\" \"winner_name\": make a bet on a match on the behalf of a player");
        System.out.println("member_manager resolve_match \"sport_name\" \"match_name\" \"winning_team_name\": end a match, declare one team won, and update members based on bets");
        System.out.println("member_manager member_info \"member_name\": return information on a member");
        System.out.println("stats_player \"sport_name\" \"player_name\" \"stat\" \"seasons\": get available data on a player of your choosing");

...
public class HockeyPlayerStatManagerTest {
    ...
    public void testExecuteTeamPasses() throws Exception {
        ...
        String output1 = this.hockeyPlayerStatManager.execute((ArrayList<String>) arguments1, container);
        ...
        String output2 = this.hockeyPlayerStatManager.execute((ArrayList<String>) arguments2, container);
        ...
        String output3 = this.hockeyPlayerStatManager.execute((ArrayList<String>) arguments3, container);
    ...
    public void testExecuteTeamNoPlayer() throws Exception {
        ...
        String fail = this.hockeyPlayerStatManager.execute((ArrayList<String>) arguments, container);
    }

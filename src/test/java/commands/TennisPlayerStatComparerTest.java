...
public class TennisPlayerStatComparerTest {
    ...
    public void testExecuteAgePasses() throws Exception {
        ...
        String output = this.tennisPlayerStatComparer.execute((ArrayList<String>) arguments, container);
    ...
    public void testExecuteAgeNoPlayer() throws Exception {
        ...
        String fail = this.tennisPlayerStatComparer.execute((ArrayList<String>) arguments, container);
    }
